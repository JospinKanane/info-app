...
function signup() {
  return (
    <div className="login flex flex-col items-center justify-center content-center mt-20 ">
      <h1 className="text-center font-bold text-4xl	mb-4">Signup</h1>
      <div>
        ...
        <div className="mb-2">
          ...
          <div className="flex items-center justify-between">
            ...
            <Link href="/auth-7Empire-admin">
              <button className="bg-red-500 hover:bg-black text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline" type="button">
                Login
              </button>
            </Link>
          </div>
